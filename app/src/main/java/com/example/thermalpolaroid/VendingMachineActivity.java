...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bitmapImage = (Bitmap) bundle.getParcelable("imagebitmap");
        ...
        button_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (connected) {
                    BluetoothGattCharacteristic ch = mBluetoothGatt.getService(hm10UartUUID).getCharacteristic(hm10UartWriteUUID);
                    String imageString = ImageProcessor.BitmapToString(bitmapImage);
                    ch.setValue(imageString);//TODO verificar como enviar a string inteira de uma vez
